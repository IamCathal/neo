...
export function setCrawlPageUserCardDetails(user, idPrefix) {
  ...
  document.getElementById(`${idPrefix}UserCountry`).textContent = countryCodeToName(user.accdetails.loccountrycode) === "" ? 'unknown' : countryCodeToName(user.accdetails.loccountrycode);
